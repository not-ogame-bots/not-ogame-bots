...
object OrdonPasiphaeConfig extends OrdonConfig {
  def getCredentials: Credentials = {
    val source = scala.io.Source.fromFile(s"${System.getenv("HOME")}/.not-ogame-bots/s168-pl.conf")
  ...
  def getInitialActions(implicit clock: LocalClock): IO[List[ScheduledAction[IO]]] = {
    ...
    val listOfActions = List(
      ...
      //      new DeployAndReturnNoLargeCargoAndPutOffersOgameAction[IO](planet7, moon7, configClass.expectedOffers),
