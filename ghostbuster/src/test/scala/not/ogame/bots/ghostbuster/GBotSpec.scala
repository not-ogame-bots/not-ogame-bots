...
//    )
//    val nextState = bot.nextStep(prevState)
//    assertEquals(nextState.scheduledTasks, List(Action.RefreshFleetOnPlanetStatus(clock.instant(), planetId1)))
//  }
//
...
//    val nextState = bot.nextStep(prevState)
//    assertEquals(nextState.scheduledTasks, List(Action.BuildSupply(SuppliesBuilding.MetalMine, 1, now, planetId1)))
//  }
//
...
//
//    val prevState = State.LoggedIn(
//      List(Action.BuildSupply(SuppliesBuilding.CrystalMine, 1, now, planetId1)),
//      List(createPlanetState(createSuppliesPage(resources = Resources(60, 15, 0)))),
//      List.empty
//    )
//    val nextState = bot.nextStep(prevState)
//    assertEquals(nextState.scheduledTasks, List(Action.BuildSupply(SuppliesBuilding.CrystalMine, 1, now, planetId1)))
//  }
...
//
//    val nextState = bot.nextStep(prevState)
//    assertEquals(nextState.scheduledTasks, List(Action.BuildSupply(SuppliesBuilding.MetalMine, 1, now.plusSeconds(6 * 3600), planetId1)))
//  }
//
...
//
//    val nextState = bot.nextStep(prevState)
//    assertEquals(nextState.scheduledTasks, List(Action.RefreshSupplyAndFacilityPage(now.plusSeconds(1), planetId1)))
//  }
//
...
//    val nextState = bot.nextStep(prevState)
//    assertEquals(
//      nextState.scheduledTasks,
//      List(Action.BuildSupply(SuppliesBuilding.MetalStorage, 1, now.plusSeconds(10 * 3600), planetId1))
//    )
//  }
//
...
//
//    val nextState = bot.nextStep(prevState)
//    assertEquals(nextState.scheduledTasks, List(Action.BuildSupply(SuppliesBuilding.SolarPlant, 1, now.plusSeconds(1 * 3600), planetId1)))
//  }
